...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def forward(self, features, proposals, targets=None):
        ...
        if self.training:
            x, detections, loss_box, roi_align_features = self.box(features, proposals, targets)
        ...
        if not self.training:
            ...
            return x, detections, losses, roi_align_features

    def calculate_soften_label(self, features, proposals, targets=None):
        soften_score, soften_bbox, roi_align_features = self.box.calculate_soften_label(features, proposals, targets)

        return soften_score, soften_bbox, roi_align_features

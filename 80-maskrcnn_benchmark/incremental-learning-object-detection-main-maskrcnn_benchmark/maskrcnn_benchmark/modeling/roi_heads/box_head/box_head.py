...
class ROIBoxHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None):
        ...
        return x, proposals, dict(loss_classifier=loss_classifier, loss_box_reg=loss_box_reg), roi_align_features
    ...
    def calculate_soften_label(self, features, proposals, targets=None):
        ...
        return soften_scores, soften_bboxes, roi_align_features

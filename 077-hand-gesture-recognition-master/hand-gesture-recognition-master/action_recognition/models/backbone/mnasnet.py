...
__all__ = ['MNASNet', 'mnasnet05', 'mnasnet075', 'mnasnet10', 'mnasnet13']
...
def _load_pretrained(model_name, model, progress):
    ...
    model.load_state_dict(torch.hub.load_state_dict_from_url(checkpoint_url, progress=progress))


def mnasnet05(pretrained=False, progress=True, **kwargs):
...
def mnasnet075(pretrained=False, progress=True, **kwargs):
...
def mnasnet10(pretrained=False, progress=True, **kwargs):
...
def mnasnet13(pretrained=False, progress=True, **kwargs):

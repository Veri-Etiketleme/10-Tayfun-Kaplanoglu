...
def calculate_roi_distillation_losses(model_source, model_target, images, gt_proposals=None, distributed=False):
    ...
    with torch.no_grad():
        soften_result, soften_proposal, feature_source, backbone_feature_source, anchor_source, rpn_output_source, roi_align_features_source = \
    ...
    return roi_distillation_losses, rpn_output_source, feature_source, backbone_feature_source, soften_result, soften_proposal, roi_align_features_source, roi_align_features_target
